...
func (c *bankingServiceClient) CreateFundAccount(ctx context.Context, in *CreateFundAccountRequest, opts ...grpc.CallOption) (*CreateFundAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, BankingService_CreateFundAccount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BankingService_CreateFundAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(BankingServiceServer).CreateFundAccount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BankingService_CreateFundAccount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BankingServiceServer).CreateFundAccount(ctx, req.(*CreateFundAccountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
