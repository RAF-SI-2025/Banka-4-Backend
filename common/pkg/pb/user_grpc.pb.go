...
func (c *userServiceClient) IncrementUsedLimit(ctx context.Context, in *IncrementUsedLimitRequest, opts ...grpc.CallOption) (*IncrementUsedLimitResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserService_IncrementUsedLimit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_IncrementUsedLimit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(UserServiceServer).IncrementUsedLimit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_IncrementUsedLimit_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).IncrementUsedLimit(ctx, req.(*IncrementUsedLimitRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_IncrementUsedLimit_Handler,
		},
	},
