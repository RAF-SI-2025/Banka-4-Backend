...
type Employee struct {
	...
	ActivationTokens []ActivationToken `gorm:"foreignKey:EmployeeID"`
	ResetTokens      []ResetToken `gorm:"foreignKey:EmployeeID"`
	RefreshTokens    []RefreshToken `gorm:"foreignKey:EmployeeID"`
}
